(function () {
    ...
    function onSessionInvalid() {
        ...
        // hide everything when we did not log in
        hideElement(itemNav);
    ...
    // 隐藏某些 先是某些 跟onsessioninvalid很类似
    ...
    function register() {
        ...
        ajax('POST', url, req,
            ...
            function (res) {
                ...
                // ResultResponse.java 里的field是result
                if (result.result === 'OK') {
    ...
    function ajax(method, url, data, successCallback, errorCallback) {
        ...
        // method的意思是用get 还是 post？
        xhr.open(method, url, true);

        xhr.onload = function() {
            if (xhr.status === 200) {
                // 成功了请继续执行 具体怎么执行实在这个cb func里
